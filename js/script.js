$(window).load(function () {
    $('#preloader').delay(350).fadeOut('slow', function () {
        $('.profile-page, .institution-page .resume-page, .portfolio-page, .gallery-page, .downloads-page .contact-page').hide();
    });
});
...
$(document).ready(function () {
    ...
    $('.menu div.profile-btn').on('click', function () {
		...
		$('.menu div.institution-btn').on('click', function () {
        $('.institution-page').fadeIn(1200);
    });	
    ...
    $('.menu div.portfolio-btn').on('click', function () {
		...
		$('.menu div.downloads-btn').on('click', function () {
        $('.downloads-page').fadeIn(1200);
    });
		
		$('.menu div.faculty-btn').on('click', function () {
    ...
    $('.close-btn').on('click', function () {
        ...
        $('.profile-page, .institution-page .resume-page, .portfolio-page, .gallery-page, .downloads-page .contact-page').fadeOut(800);
				$('.resume-page, .downloads-page, .institution-page, .contact-page').hide();
    });
    ...
    $(function () {
        ...
        // Initiate MixItUp
			...
			var mixer = mixitup('.achievements-container');
    });
